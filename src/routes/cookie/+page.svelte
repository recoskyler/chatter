<div class="text-black bg-white flex flex-col p-10 gap-5 h-screen overflow-y-auto">
  ...
  <p>
    This is the Cookie Policy for Chatter, accessible from
    https://chatter.recoskyler.com
  </p>
  ...
  <ul>
    ...
    <li class="my-2">
      ...
      <p>
        When you submit data to through a form such as those found on create account or edit profile forms cookies may be set to limit the rate of your actions.
      </p>
    </li>
  </ul>
