<script lang="ts">
  ...
  let selectedChat: number = 0;
    ...
    if (lastPrompt !== null && Math.abs((Date.now() - lastPrompt.getTime()) / 1000) < 3) {
    ...
    const body = {
      ...
      "messages": $chats[selectedChat].messages.map(
        (e: Prompt) => ({
            "role": e.role,
            "content": e.content,
        }),
    ...
    try {
      ...
      const inputBox = document.getElementById("prompt-input") as HTMLTextAreaElement;
...
<div class="app">
  ...
  <navbar>
      <nav>
          ...
          {#each $chats as {title}, index}
            <div class="chat-button-cont">
              ...
              >
                <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><path d="M7 7h18v22H7zM3 7h26M13 3h6M13 12v10M19 12v10" fill="none" stroke="#a3a3a3" stroke-linecap="round" stroke-linejoin="round" stroke-width="2px" class="stroke-000000"></path></svg>
              </button>
            </div>
          {/each}
      ...
      <footer>
          <p>
              Made with <a href="/deniz">🫀</a> by <a href="https://github.com/recoskyler">recoskyler</a> — <a href="github.com/recoskyler/chatter">GitHub</a>
          </p>
      </footer>
  </navbar>
          ...
          <div class="chat-input-box">
            <div id="chat-form">
              ...
              <button class="submit" on:click={() => submitPrompt()}>
                <svg viewBox="0 0 80 80" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 80 80">
                  <path d="M40 5.4C20.9 5.4 5.4 20.9 5.4 40S20.9 74.6 40 74.6 74.6 59.1 74.6 40C74.5 20.9 59.1 5.5 40 5.4zm0 66.2C22.6 71.6 8.4 57.4 8.4 40S22.6 8.4 40 8.4 71.6 22.6 71.6 40C71.5 57.4 57.4 71.5 40 71.6z" fill="#a3a3a3" class="fill-000000"></path>
                  <path d="M21.4 16.5 32.2 40 21.4 63.5 63.1 40 21.4 16.5zm6.6 7.2 26.3 14.8H34.8L28 23.7zm6.8 17.8h19.5L28 56.3l6.8-14.8z" fill="#a3a3a3" class="fill-000000"></path>
                </svg>
              </button>
            </div>
          </div>
...
<style>
    ...
    .chat-button:hover, .new-chat-button:hover {
        color: black;
